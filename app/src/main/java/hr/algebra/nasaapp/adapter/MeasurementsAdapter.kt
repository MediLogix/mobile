...
class MeasurementsAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val editButton: MaterialButton = itemView.findViewById(R.id.editMeasurementButton)
        private val deleteButton: MaterialButton = itemView.findViewById(R.id.deleteMeasurementButton)
